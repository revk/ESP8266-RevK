...
uint8_t PN532RevK::cardsPresent (int timeout)
...
uint8_t
PN532RevK::getID (String & id1, int timeout)
{                               // Return tag id
...
uint8_t
PN532RevK::data (uint8_t txlen, uint8_t * tx, uint8_t & rxlen, uint8_t * rx, int timeout)
...
uint8_t PN532RevK::release (int timeout)
{
   if (!Tg1)
